...
def pcl_callback(pcl_msg):
    n = 0
    while(True and n < NUM_ITERATIONS):
        # Exercise-2 TODOs:
...
def pr2_mover(object_list):
    ...
    for object in object_list:
        ...
        pick_pose.orientation.x = np.asscalar(centroid[0])
        pick_pose.orientation.y = np.asscalar(centroid[1])
        pick_pose.orientation.z = np.asscalar(centroid[2])
        ...
        place_pose.orientation.x = dropbox_position_list[dropbox_index][0]
        place_pose.orientation.y = dropbox_position_list[dropbox_index][1]
        place_pose.orientation.z = dropbox_position_list[dropbox_index][2]
        place_pose.orientation.w = 40
...
if __name__ == '__main__':
    ...
    model = pickle.load(open('model_test3_world_1000_instances.sav', 'rb'))
